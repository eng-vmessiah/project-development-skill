...
**Status:** E1/E1R/E2/E3/E4 closed; E5 unblocked.
...
E5 — decide and specify CLI read-only exposure only after the Supervisor facade gate.
...
- Adversarial coverage includes strict IDs/statuses, hostile mappings/len/getattr/bool/deepcopy, deterministic timestamps, summary-only checkpoint payloads, sequence anomalies, read-only facade invariance and no forbidden integration.
